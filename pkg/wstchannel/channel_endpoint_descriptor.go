...
var pbEndpointRoleToChannelEndpointRole = map[interproxy.PbEndpointRole]ChannelEndpointRole{
	interproxy.PbEndpointRole_UNKNOWN:  ChannelEndpointRoleUnknown,
	interproxy.PbEndpointRole_STUB:     ChannelEndpointRoleStub,
	interproxy.PbEndpointRole_SKELETON: ChannelEndpointRoleSkeleton,
}

var channelEndpointRoleToPbEndpointRole = map[ChannelEndpointRole]interproxy.PbEndpointRole{
	ChannelEndpointRoleUnknown:  interproxy.PbEndpointRole_UNKNOWN,
	ChannelEndpointRoleStub:     interproxy.PbEndpointRole_STUB,
	ChannelEndpointRoleSkeleton: interproxy.PbEndpointRole_SKELETON,
}

// ToPb converts a ChannelEndpointRole to its protobuf value
func (x ChannelEndpointRole) ToPb() interproxy.PbEndpointRole {
	result, ok := channelEndpointRoleToPbEndpointRole[x]
	if !ok {
		result = interproxy.PbEndpointRole_UNKNOWN
	}
	return result
}

// PbToChannelEndpointRole returns a ChannelEndpointRole from its protobuf value
func PbToChannelEndpointRole(pbRole interproxy.PbEndpointRole) ChannelEndpointRole {
...
func (x *ChannelEndpointRole) FromPb(pbRole interproxy.PbEndpointRole) {
...
func (d *ChannelEndpointDescriptor) ToPb() *interproxy.PbEndpointDescriptor {
	return &interproxy.PbEndpointDescriptor{
		Role: d.Role.ToPb(),
		Type: d.Type.ToPb(),
		Path: d.Path,
	}
