...
// WriteCloseHalfCloser is an interface that includes both WriteCloser and WriteHalfCloser
type WriteCloseHalfCloser interface {
	io.WriteCloser
	WriteHalfCloser
}

// ReadCloseHalfCloser is an interface that includes both ReadCloser and ReadHalfCloser
type ReadCloseHalfCloser interface {
	io.ReadCloser
	ReadHalfCloser
}

// ReadWriteCloseWriteHalfCloser is an interface that includes ReadWriteCloser
// and WriteHalfCloser
type ReadWriteCloseWriteHalfCloser interface {
	io.ReadWriteCloser
	WriteHalfCloser
}

// ReadWriteCloseHalfCloser is an interface that includes ReadWriteCloser
// and ReadWriteHalfCloser
type ReadWriteCloseHalfCloser interface {
	io.ReadWriteCloser
	ReadWriteHalfCloser
}
